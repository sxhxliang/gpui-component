...
use gpui_component::{
    ...
    v_flex, ActiveTheme, Icon, IconName, Selectable, Sizable, StyledExt as _,
};
        ...
        h_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(div().text_sm().text_color(theme.foreground).child("Home")),
            )
            .child(
    ...
    fn render_tree_view(&self, cx: &Context<Self>) -> impl IntoElement {
        v_flex()
            ...
            .children(
                self.projects
                    .iter()
                    .map(|project| self.render_project_group(project, cx)),
            )
    }
                ...
                this.child(self.render_new_workspace_button(cx))
                    .children(
                        project
                            .worktrees
                            .iter()
                            .map(|worktree| self.render_worktree_item(worktree, cx)),
                    )
            })
    }
